...
if __name__=='__main__':
	...
	#Vertical roads
	grid.add_road(0, 3, 0, 2, length=10, maxspeed=2)
	grid.add_road(3, 7, 0, 2, length=10, maxspeed=2)
	grid.add_road(7, 10, 0, 2, length=10, maxspeed=2)
	
	grid.add_road(11, 8, 2, 0, length=10, maxspeed=2)
	grid.add_road(8, 4, 2, 0, length=10, maxspeed=2)
